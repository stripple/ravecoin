...
"""Verify that starting ravecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ravecoin with -h for help text")
        ...
        self.log.info("Start ravecoin with -version for version information")
        ...
        self.log.info("Start ravecoind with -fakearg to make sure it does not start")
