...
const char * const BITCOIN_CONF_FILENAME = "ravecoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Ravecoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Ravecoin";
#else
    // Unix
    return pathRet / ".ravecoin";
#endif
#endif
}
