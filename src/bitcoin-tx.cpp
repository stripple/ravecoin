...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ravecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ravecoin-tx [options] <hex-tx> [commands]  Update hex-encoded ravecoin transaction\n" +
            "or:     ravecoin-tx [options] -create [commands]   Create hex-encoded ravecoin transaction\n" +
            "\n";
