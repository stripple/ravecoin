...
bech32_templates = [
  ...
  ('rve',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('rve',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('rve',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('trve',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('trve',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('trve',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rrve',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rrve',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rrve', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('trve',  17, 32, False, False, False),
  ('rrve',  3,  1, False, False, False),
  ('rve',   15, 41, False, False, False),
  ('trve',  0, 16, False, False, False),
  ('rrve',  0, 32, True,  False, False),
  ('rve',   0, 16, True,  False, False),
  ('trve',  0, 32, False, True,  False),
  ('rrve',  0, 20, False, False, True)
]
