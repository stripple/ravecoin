# Support for Output Descriptors in Ravecoin Core

Since Ravecoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `rve1...` for mainnet or `trve1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Ravecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Ravecoin Core wallets, a convenience function `combo` is
